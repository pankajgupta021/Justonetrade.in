 ...
 * Dual mode switcher (Direct Bot + Web WhatsApp).
 * Kept here safely for future reference.
 */

import { useState } from "react";
import { WhatsAppDirectSignalGenerator } from "../WhatsAppDirectSignalGenerator";
import { ArchivedSignalGenerator } from "./SignalGenerator";
import { Zap, Globe } from "lucide-react";
import { Button } from "@/components/ui/button";

export function ArchivedAdminSignalDashboard() {
